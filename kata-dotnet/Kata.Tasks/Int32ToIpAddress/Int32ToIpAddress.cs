...
public class Int32ToIpAddress
{
    ...
    public string ConvertInt32ToIp()
    {
        ...
        var partCount = 4;
        var partLength = 8;
        var ipLength = partCount * partLength;
        var byteString = Convert.ToString(ip, 2);

        var sb = new StringBuilder(byteString);
        ...
        for (var i = 0; i < intermediateString.Length; i += partLength)
        {
