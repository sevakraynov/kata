...
public static class AlphabetWars
{
    ...
    private static readonly Dictionary<char, int> leftSide = new()
    {
        { 'w', 4 },
        { 'p', 3 },
        { 'b', 2 },
    ...
    /// <typeparam name="char">Letter</typeparam>
    /// <typeparam name="int">Power</typeparam>
    private static readonly Dictionary<char, int> rightSide = new()
    {
        { 'm', 4 },
        { 'q', 3 },
        { 'd', 2 },
    ...
    public static string AirStrike(string fight)
    {
        ...
        for (var i = 0; i < fightCharArray.Length; i++)
        {
            if (fightCharArray[i] == '*')
            {
    ...
    private static string WhoIsWin(string str)
    {
        ...
        {
            if (leftSide.TryGetValue(letter, out var l))
            {
                countLeft += l;
            }

            if (rightSide.TryGetValue(letter, out var r))
            {
                countRight += r;
            }
        }
